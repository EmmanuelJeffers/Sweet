...
public  class Pivot extends SubsystemBase {
    ...
    public Pivot() {
         ...
         pivotPidController = new PIDController(0.17, 0, 0);
    ...
    public void pivotGoHome() {
       pivotMotor.set(-pivotPidController.calculate(pivotEncoder.getPosition(), PivotConstants.homeSetpoint));
      }
    public void pivotGoIntake() {
       pivotMotor.set(pivotPidController.calculate(pivotEncoder.getPosition(), PivotConstants.intakeSetpoint));
    }
